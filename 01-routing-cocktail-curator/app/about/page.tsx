    ...
    <main className="mx-auto flex max-w-7xl flex-col items-center gap-8 px-6 py-12 text-lg md:gap-12">
      <div className="flex w-full flex-col max-lg:items-center max-lg:space-y-4 lg:flex-row lg:justify-around">
        ...
        <div className="flex flex-col space-y-6 md:w-lg md:text-xl">
          <p className="md:text-md text-sm font-medium text-gray-600 uppercase md:block">
            About T Cocktails
          </p>
          <h1 className="font-mont-alt text-4xl font-bold md:text-5xl">
      ...
      <div className="flex w-full flex-col text-base max-sm:space-y-9 md:flex-row md:gap-8 md:px-10">
        <article className="space-y-3 md:w-xs">
          <h2 className="font-mont-alt text-2xl font-bold">
            <Martini className="mr-1 inline-block -translate-y-[2px] text-gray-600" />
            40+ Creations
          </h2>
        ...
        <div className="mx-4 hidden h-auto border-l border-gray-600 md:block"></div>
        <article className="space-y-3 md:w-xs">
          <h2 className="font-mont-alt text-2xl font-bold">
            <BottleWine className="mr-1 inline-block -translate-y-[2px] text-gray-600" />
            Active Community
          </h2>
          <p className="text-gray-600">
        ...
        <article className="space-y-3 md:w-xs">
          <h2 className="font-mont-alt text-2xl font-bold">
            <Wine className="mr-1 inline-block -translate-y-[2px] text-gray-600" />
            Free to Enjoy
          </h2>
          <p className="text-gray-600">
      ...
      <div className="flex flex-col space-y-6 md:w-2xl md:text-xl">
        ...
        <hr className="mx-auto w-2/3 border-black" />
